...
public class CommandValidationDecoratorGenericTests {
    public sealed record FakeCommand(string Value) : ICommand<FakeResult>;
    ...
    public async Task HandleAsync_ShouldReturnFailure_WhenValidationFails() {
        ...
        var decorator = new CommandValidationDecorator<
            FakeCommand,
            FakeResult
        >(
            inner,
        ...
        await inner.DidNotReceive()
            .HandleAsync(Arg.Any<FakeCommand>(), Arg.Any<CancellationToken>());
    }
